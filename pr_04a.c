...
g:
        push    rbp
        mov     rbp, rsp
        mov     eax, 0   ; копирование 0 в специальный регистр (accumulator), откуда вызываемая сторона сможет прочитать возвращенное значение функции
        pop     rbp
        ret
...
// вызов функции: h(1, 2);
        ...
        call    h
// с присваиванием возвращаемого значения: int x = h(1, 2);
        mov     esi, 2
        mov     edi, 1
        call    h
