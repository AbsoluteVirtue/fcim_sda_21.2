...
11. insert -- добавляет элемент в список по ссылке (для односвязного списка - следующим элементом относительно аргумента)
12. erase -- удаляет элемент из списка по ссылке (для односвязного списка - следующий элемент относительно аргумента)
*/
